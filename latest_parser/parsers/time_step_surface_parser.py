...
class TimeStepSurfaceParserDistributed(Parser):
    ...
    def _process(self, surface_id: int, time_step: float = 1.0) -> None:
        """
    ...
    def inspect(self, surface_id: int, time_step: float = 1.0) -> Dict:
        """
        Runs a single end to end parser pipeline on a single surface
...
#############################################################################
# DOUBLE CHECK THIS
# DO WE NEED TRACK IDS OR OBJECT IDS TO PERFORM FILTERING
