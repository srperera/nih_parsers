        ...
        if len(imaris_files) == 0:
            ...
            for file_path in imaris_files:
                ...
                try:
                    ...
                    run_summary[data_path][filename]["all_tracks"] = valid_surface_ids
                ...
                if len(valid_surface_ids) == 0:
                    ...
                    run_summary[data_path][filename]["extracted_tracks"] = []
                    for idx in valid_surface_ids:
                        ...
                        # update summary
                        run_summary[data_path][filename]["extracted_tracks"].append(idx)
                print("\n")

        run_summary[data_path]["total surfaces with tracks"] = len(actors)
